...
import { botInfo, congratulateCelebration, fagotDetect, fagotsTop, findFag, logger } from './src/app/AppService.js'
...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.commandName === CMD_PIDOR_DETECT) {
    ...
    await fagotsTop(interaction.options.getString('start_date'), interaction.options.getString('end_date'))
